...
#text(size: 14pt)[
  ...
  *Gyanmanjari Innovative University* is a bonafide record of original project#linebreak(justify: true)
  ...
  has been directly copied from any other student’s report or taken from any other#linebreak(justify: true)
...
#align(left)[
  ...
  #v(1.2em)
  #text(size: 14pt, weight: "bold")[Student’s Signature :]
]
#v(1em)
...
#align(left)[
  ...
  #text(
    size: 12pt,
  )[The proposed project, *PROJECT NAME*, is a comprehensive software application designed to fulfill the operational and business requirements of the organization.]
...
#align(left)[
  ...
  #text(
    size: 12pt,
  )[The primary objective of the *PROJECT NAME* project is to provide an efficient, robust, and user-friendly digital platform.]
  ...
  #text(
    size: 12pt,
  )[The *PROJECT NAME* project is developed to support streamlined operations, data integrity, and intuitive user experiences.]
